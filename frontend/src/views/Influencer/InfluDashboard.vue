    ...
    <div style="margin-top: 6em;">
      ...
      <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <button style="margin-left: 2em;" class="btn btn-primary" @click="navigateToPublicCampaigns">
            See All Public Campaigns
          </button>
          <div class="container"></div>
          <button style="margin-right: 2em;" class="btn btn-warning" @click="navigateToInfluProfile">
            Update Profile
          </button>
      ...
      <div style="margin-top: 2em; margin-bottom: 2em;" class="welcome-message ">
        <h2 style="font-weight: bold;">Welcome, {{ userName || "User-Influencer" }}!</h2>
      </div>
      ...
      <table v-if="data.length" class="table table-striped table-bordered">
        ...
        <tbody>
          <tr v-for="item in data" :key="item.id">
            ...
            <td>
              <div v-if="item.status === 'Pending' && item.campaign_id.visibility !== 'public'">
                <button
