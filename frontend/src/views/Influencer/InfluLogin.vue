<template>
    <div id="app">
      ...
      <div class="wrapper">
        ...
        <form @submit.prevent="login">
          ...
          <!-- Signup Link -->
          <div class="text">
            <h3>Don't have an account? <router-link to="/influencer/register">Sign up now</router-link></h3>
          </div>
        </form>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      async login() {
        try {
          const response = await axios.post('http://127.0.0.1:5000/influencer/login', {
