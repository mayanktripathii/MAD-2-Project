...
<template>
  ...
  <div>
    <div class="container" style="margin-top: 5em;">
      ...
      <h2 style="font-weight: bold;">Update the Campaign</h2>
  ...
  methods: {
    async fetchCampaignData() {
      ...
      try {
        ...
        this.campaign.start_date = this.formatDate(this.campaign.start_date);
        this.campaign.end_date = this.formatDate(this.campaign.end_date);
      } catch (error) {
