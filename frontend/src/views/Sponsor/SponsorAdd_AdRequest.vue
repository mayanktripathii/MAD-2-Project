...
<template>
  ...
  <div class="container mt-5">
    <h2 style="font-weight: bold;">Add Ad Request Data</h2>
  ...
  methods: {
    async fetchCampaigns() {
      try {
        ...
        console.log("Sponsor ID from localStorage:", sponsorId);



        this.campaigns = response.data.filter(
          (campaign) => campaign.sponsor_id == sponsorId
        );
        console.log("Filtered Campaigns:", this.campaigns);
