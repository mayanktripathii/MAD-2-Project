...
<template>
    <div><Logout DashboardTitle="Search Influencers"></Logout></div>
  
  <div style="margin-top: 6em;" class="container mt-8">
    <h2 style="font-weight: bold;" class="text-center mb-4">Influencers List</h2>
