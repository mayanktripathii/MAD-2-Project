...
def send_daily_reminders():
    with app.app_context():
        ...
        for user in users:
            pending_ad_requests = AdRequest.query.filter_by(influencer_id=user.id, status='pending').all()
    ...
    with app.app_context():
        ...
        for sponsor in sponsors:
            ...
            report_data = [{'campaign': campaign.to_dict(),
                            'ad_requests': [ad.to_dict() for ad in AdRequest.query.filter_by(campaign_id=campaign.id).all()]
